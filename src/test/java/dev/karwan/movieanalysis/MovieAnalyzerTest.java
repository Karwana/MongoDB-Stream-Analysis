...
public class MovieAnalyzerTest {
    ...
    List<Movie> testMovies = List.of(
            ...
            new Movie("3", "Heist", 1980, List.of("Drama"), "Christopher Nolan", List.of("Brad Pitt", "Tom Hardy"), 7.2, List.of("Spanish"), 240),
    ...
    @Test
    void movieWithTheFewestActorsListed() {
        String expected = "The Hunt";
        String actual = analyzer.movieWithTheFewestActorsListed(testMovies);
        Assertions.assertEquals(expected, actual);
    }
